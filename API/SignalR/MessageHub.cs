...
namespace API.SignalR
{
    ...
    public class MessageHub: Hub
    {
        ...
        public async Task SendMessage(CreateMessageDto createMessageDto)
        {
            ...
            if(recepient == null) throw new HubException("Not Found");
            ...
            var message = new Message
            {
             ...
             if(group.Connections.Any(q => q.Username == recepient.UserName))
             {
                message.DateRead = DateTime.UtcNow;
             }
             else
             {
                var connections = await PresenceTracker.GetConnectionForUser(recepient.UserName);
                if(connections != null)
                {
        ...
        private async Task<Group> RemoveFromMessageGroup()
        {
            ...
            _uow.MessageRepository.RemoveConection(connection);
